...
@section('content')
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        {{@$heading}}
        <a href="{{url('admin/add-staff')}}" class="btn btn-success pull-right"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Staff</a>
      </h1>
    </section>
         ...
         <div class="box box-success box-solid">
            <div class="box-header with-border">
              <h3 class="box-title">Staff List  </h3>
               <a href="{{URL::to('admin/staff-export')}}" class="btn btn-success pull-right" style="border-color: #ecf0f5;"><i class="fa fa-file-excel-o"></i> Export </a> 
            </div>
            <!-- /.box-header -->
            <div class="box-body table-responsive">
              ...
              <table id="staff-table" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th>Name</th>
                  <th class="removeSortingClass">Mobile Number</th>
                  <th class="removeSortingClass">Email</th>
...
{!! Html::script('public/custom/plugnis/fancybox/source/jquery.fancybox.js') !!}
	<script type="text/javascript">
 	 $(document).ready(function() {
        ...
        window.datatable = $('#staff-table').DataTable({
            //"order": [[ 0, "desc" ]],
            "columnDefs": [ {
