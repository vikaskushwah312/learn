        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-success box-solid">
                    ...
                    <!-- form start -->
                    {!! Form::open(array('url' => 'admin/add-passenger','id'=>"AddPassengerForm", 'name'=>"AddPassengerForm",'files'=>true,'method' => 'POST','class' => '')) !!}
                   ...
                   <div class="row">
                     <div class="form-group {{ $errors->has('password') ? ' has-error' : '' }} col-md-6">
                      ...
                      <div class="form-group {{ $errors->has('gender') ? ' has-error' : '' }} col-md-6">
                        ...
                        <p class="controll-error help-block" id="er_gender">
                           @if ($errors->has('gender'))</i><span style="color:red;">{{ $errors->first('gender') }}</span></p> @endif
                        </p>
                     </div>
                    </div>
                    <div class="row">
                      <div class="form-group {{ $errors->has('profile_image') ? ' has-error' : '' }} col-md-6">
                        ...
                        <input name="profile_image" id="profile_image" type="file" value="{{old('profile_image')}}" />
                    ...
                    <div class="box-footer">
                        ...
                        <a href="{{url('admin/passengers')}}" class="btn-flat btn btn-default"><i class="fa fa-arrow-left"></i> Go Back</a>
