        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-success box-solid">
                    ...
                    <!-- form start -->
                    {!! Form::open(array('url' => 'admin/add-state','id'=>"StateForm", 'name'=>"StateForm",'files'=>true,'method' => 'POST','class' => '')) !!}
                    <div class="box-body">
                       <div class="center">
                          <div class="row">
                               ...
                               <select name="country_id" id="country_id" class="form-control" onchange="select_country()">
                                      ...
                                      @if(count($country) > 0)
                                        @foreach($country as $value)
                                          ...
                                          <option value="{{ $value->id }}" <?php  echo (!empty($state_info))?(($value->id == $state_info->country_id)?('selected'):(old('country_name'))):(old('country_name')); ?>>{{ $value->country_name }}</option>
                            ...
                            <div class="form-group col-md-6">
                               ...
                               <input type="text" name="state_name" id="state_name" placeholder="State Name" value="<?php echo (!empty($state_info))?($state_info->state_name
