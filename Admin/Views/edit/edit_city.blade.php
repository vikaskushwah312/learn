    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-successd box-solid">
                    ...
                    <!-- form start -->
                    {!! Form::open(array('url' => "admin/edit-city/$city_info->id",'id'=>"CityForm", 'name'=>"CityForm",'files'=>true,'method' => 'POST','class' => '')) !!}
                    <div class="box-body">
                       <div class="center">
                            <div class="form-group col-md-6">
                               ...
                               <select name="country" id="country" class="form-control" onchange="select_country()">
                                ...
                                <p class="controll-error help-block" id="er_country">@if ($errors->has('country_id')) <i class="errors"></i>{{ $errors->first('country_id') }} @endif</p>
                            </div>
                           <div class="form-group {{ $errors->has('country_id') ? ' has-error' : '' }} col-md-6">
                             ...
                             <select name="state" id="state" class="form-control">
                              ...
                              <p class="controll-error help-block" id="er_state">@if ($errors->has('state')) <i class="errors"></i>{{ $errors->first('state') }} @endif</p>
                          </div>
                            <div class="form-group {{ $errors->has('city_name') ? ' has-error' : '' }} col-md-6">
                               ...
                               <input type="text" name="city_name" id="city_name" placeholder="State Name" value="<?php echo (!empty($city_info))?($city_info->city_name
                                ):(old("city_name")); ?>" maxlength="50" class="form-control">
