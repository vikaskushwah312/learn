               ...
               <div class="media media-new">
                  ...
                  <div class="media-body">
                     <div class="log in-form px-5 py-5 text-left">
                        ...
                        <div class="row">
                           @if($info->gender == 'Male')
                           <div class="col select_gender" style="margin-left:5px;">
                        ...
                        <div class="row">
                          <div class="form-group " style="margin-left:20px;">
                           <div class="form-group mb-4" >
                              <div class="fancy"><input name="profile_image" id="profile_image" type="file"/>
                               {!! Html::image(Config::get('constants.PROFILE_IMAGE').$info->profile_image,'',['alt' => 'User profile picture','class' => 'profile-user-img','id' => 'preview_image',"style" => 'width:100px;height:100px;'])!!} 
                        ...
                        <button type="submit" id="get_profile" class="btn btn-block theme-btn-new mt-3">update profile</button>
...
<table><tr><td>
                <button type="submit" class="btn btn-default theme_btn " style="background-color:#98bb00;color:white; margin-left:45px;">Change Password</button>
   </td><td>
...
<script type="text/javascript">
   $("form[name='editProfileForm']").validate({
     ...
     submitHandler: function(form) {
       ...
       make_disable_enable('add', 'get_profile',"Please Wait...");
       ...
       $.ajax({
               ...
               success: function(res){
                  ...
                  make_disable_enable('remove', 'get_profile', 'update profile');
