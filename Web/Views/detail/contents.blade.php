...
<div class="login-box">
  <div class="login-logo">
    {!! Html::image('public/uploads/logo/logo.png', '', array('width' => 60,'height' => 60)) !!}
  </div>
  <button type="button" class="btn btn-link"><a href="#">Privacy Policy</a></button>
  <button type="button" class="btn btn-link"><a href="#">Terms & Conditions </a></button>
  <h4 class="text-center"><a href="javascript:history.back()">Go To Back</a></h4>
</div>
<!-- /.login-box -->
<style>
